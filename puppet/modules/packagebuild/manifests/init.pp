...
class packagebuild {
  ...
  $mono_build_essentials = [ 'mono-runtime', 'mono-gmcs', 'xsltproc', 'automake', 'gettext', 'libtool', 'autoconf', 'g++', 'libglib2.0-dev', 'libpng12-dev',
                               'libfreetype6-dev', 'libfontconfig1-dev', 'libx11-dev', 'libjpeg8-dev', 'libgif-dev', 'libexif-dev' ]
                               
                               # $mono_build_essentials = [ 'mono-gmcs', 'mono-complete', 'mono-runtime', 'xsltproc', 'automake', 'gettext', 'libtool', 'autoconf', 'g++', 'libglib2.0-dev', 'libpng12-dev', 
                               #'libfreetype6-dev', 'libfontconfig1-dev', 'libx11-dev', 'libjpeg8-dev', 'libgif-dev', 'libexif-dev' ]
